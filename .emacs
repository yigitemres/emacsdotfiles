...
(use-package format-all :straight t :no-require t)
...
(use-package lsp-helm :straight (helm-lsp) :no-require t :after (lsp-mode helm))
(use-package lsp-mode :straight t :no-require t :config (load-file "~/.emacs.d/settings/configs/lsp-mode.el"))
(use-package lsp-treemacs :straight t :no-require t :after lsp-mode)
...
(use-package org-bullets :straight t :no-require t :config (load-file "~/.emacs.d/settings/configs/org-bullets.el") :after org)
(use-package org-cliplink :straight t :no-require t :after org)
(use-package org-download :straight t :no-require t :after org)
(use-package org-ioslide :straight (ox-ioslide) :no-require t :after org)
(use-package org-page :straight t :no-require t :after org)
(use-package org-protocol-capture-html :straight (org-protocol-capture-html :host github :repo "alphapapa/org-protocol-capture-html") :no-require t :after org)
(use-package org-reveal :straight (ox-reveal) :no-require t :after org)
(use-package org-timeline :straight t :no-require t :after org)
(use-package org-toc :straight (toc-org) :no-require t :after org)
...
(use-package swiper-helm :disabled :straight t :no-require t :after helm)
